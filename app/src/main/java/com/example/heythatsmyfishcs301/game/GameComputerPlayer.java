			...
			if (data instanceof GameInfo) { // ignore non GameInfo objects
				...
				if (game == null) {
					...
					if (myInfo instanceof BindGameInfo) {
						...
						game.sendAction(new MyNameIsAction(com.example.heythatsmyfishcs301.game.GameComputerPlayer.this, name));
					}
				}
					...
					if (myInfo instanceof StartGameInfo) {
						...
						game.sendAction(new ReadyAction(com.example.heythatsmyfishcs301.game.GameComputerPlayer.this));
					}
				}
					...
					game.sendAction(new GameOverAckAction(com.example.heythatsmyfishcs301.game.GameComputerPlayer.this));
