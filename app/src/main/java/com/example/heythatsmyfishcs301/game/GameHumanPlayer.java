package com.example.heythatsmyfishcs301.game;

import com.example.heythatsmyfishcs301.game.actionMsg.GameOverAckAction;
import com.example.heythatsmyfishcs301.game.actionMsg.MyNameIsAction;
import com.example.heythatsmyfishcs301.game.actionMsg.ReadyAction;
import com.example.heythatsmyfishcs301.game.infoMsg.BindGameInfo;
...
import com.example.heythatsmyfishcs301.game.infoMsg.StartGameInfo;
import com.example.heythatsmyfishcs301.game.infoMsg.TimerInfo;
import com.example.heythatsmyfishcs301.game.util.GameTimer;
import com.example.heythatsmyfishcs301.game.util.MessageBox;
import com.example.heythatsmyfishcs301.game.util.Tickable;
...
public abstract class GameHumanPlayer implements GamePlayer, Tickable {
	...
	private class Unflasher implements Runnable {
		...
		public void run() {
			View top = com.example.heythatsmyfishcs301.game.GameHumanPlayer.this.getTopView();
			if (top == null) return;
		...
		public void run() {
			...
			if (game == null) {
				...
				if (myInfo instanceof BindGameInfo) {
					...
					game.sendAction(new MyNameIsAction(com.example.heythatsmyfishcs301.game.GameHumanPlayer.this, name));
				}
			}
				...
				if (myInfo instanceof StartGameInfo) {
					...
					game.sendAction(new ReadyAction(com.example.heythatsmyfishcs301.game.GameHumanPlayer.this));
				}
			}
				...
				game.sendAction(new GameOverAckAction(com.example.heythatsmyfishcs301.game.GameHumanPlayer.this));
