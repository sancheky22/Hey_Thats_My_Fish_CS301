...
import com.example.heythatsmyfishcs301.game.util.IPCoder;
import com.example.heythatsmyfishcs301.game.util.NetworkObjectPasser;
...
public class ProxyGame implements Game {
     ...
     * @return
     */
    public static com.example.heythatsmyfishcs301.game.ProxyGame create(int portNum, String ipCode) {
    	// create the game object
    	com.example.heythatsmyfishcs301.game.ProxyGame rtnVal = new com.example.heythatsmyfishcs301.game.ProxyGame(portNum, ipCode);
        	...
        	public void onReceiveObject(Object obj) {
        		...
        		try {
        			...
        			if (b) {
        				...
        				gs.setGame(com.example.heythatsmyfishcs301.game.ProxyGame.this);
        				synchronized(this) {
        					if (player == null) {
