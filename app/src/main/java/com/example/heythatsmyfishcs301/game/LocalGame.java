...
import com.example.heythatsmyfishcs301.game.actionMsg.TimerAction;
...
import com.example.heythatsmyfishcs301.game.infoMsg.IllegalMoveInfo;
...
public abstract class LocalGame implements Game, Tickable {
	...
	public void start(GamePlayer[] players) {
		...
		synchronized(this) {
			...
			Runnable runnable = new Runnable() {
				public void run() {
					Looper.prepare();
					myHandler = new MyHandler(com.example.heythatsmyfishcs301.game.LocalGame.this);
					Looper.loop();
				}
			};
	...
	private static class MyHandler extends Handler {
		// the game
		private com.example.heythatsmyfishcs301.game.LocalGame game;
		
		// constructor; parameter is expected to be this game
		public MyHandler(com.example.heythatsmyfishcs301.game.LocalGame game) {
			this.game = game;
		}
